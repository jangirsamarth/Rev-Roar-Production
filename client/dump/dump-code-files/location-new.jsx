...
// Replacing Next.js Image and Link with standard <img> and <a>
import { 
  MapPin, 
  Calendar, 
  ChevronRight, 
...
const destinations = [
  {
    ...
    highlights: [
      ...
      {
        name: "Leh Palace",
        description: "A former royal palace with panoramic views of the surrounding mountains",
        image: "/placeholder.svg?height=400&width=600",
      },
    ],
  },
...
export default function LocationsPage() {
  // Removed TypeScript type annotation for activeDestination
              ...
              <div key={destination.id} className="scroll-mt-20" id={destination.id}>
                      ...
                      <button
                        onClick={() =>
                          setActiveDestination(
                            activeDestination === destination.id ? null : destination.id
                          )
                        }
                ...
                {index < destinations.length - 1 && (
                  <motion.div
                    ...
                    className="w-full max-w-md mx-auto mt-20 border-b border-gray-200"
                  />
                )}
              </div>
            ))}
